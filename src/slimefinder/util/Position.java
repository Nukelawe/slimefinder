...
public class Position {
	...
	/**
	 * Creates a new Position object by reading a comma separated pair of integers from a string
	 * @param parseText - The string to be parsed
	 * @return Position object parsed from the string, null if the string is empty or only whitespace.
	...
	public String toString() {
		return x + "," + z;
		//return String.format("%1$9d,%2$-9d", x, z);
	}	
